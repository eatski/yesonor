                ...
                {fields.map((_, index) => (
                    <div key={index} className={styles.questionExampleItem}>
                        <QuestionExampleForm
                            ...
                            questionError={(errors.questionExamples && errors.questionExamples[index]?.question?.message) ?? null}
                            answerInput={register(`questionExamples.${index}.answer`)}
                            supplementInput={register(`questionExamples.${index}.supplement`)}
                            supplementError={(errors.questionExamples && errors.questionExamples[index]?.supplement?.message) ?? null}
